...
mysql --user="${DB_USERNAME}" -h ${DB_HOST} --password="${DB_PASSWORD}" -e "USE ${DB_NAME};SET FOREIGN_KEY_CHECKS=0;"
RAILS_ENV=test bundle exec rake db:schema:load
mysql --user="${DB_USERNAME}" -h ${DB_HOST} --password="${DB_PASSWORD}" -e "USE ${DB_NAME};SET FOREIGN_KEY_CHECKS=1;"
